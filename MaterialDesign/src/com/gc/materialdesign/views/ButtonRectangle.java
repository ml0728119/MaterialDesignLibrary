...
//		paddingTop = Utils.dpToPx(16, getResources());
    ...
    private void setText(AttributeSet attrs) {
        ...
        if (text != null) {
            ...
            textButton.setTextColor(Color.parseColor("#E1E1E1"));
    ...
    private void setPadding(AttributeSet attrs) {
        // Set Padding
...
//		}
    ...
    private void setBackgroundColor(AttributeSet attrs) {
        // Color by resource
    ...
    private void setTextColor(AttributeSet attrs) {
        // Color by resource
        int bacgroundColor = attrs.getAttributeResourceValue(ANDROIDXML, "textColor", -1);
        if (bacgroundColor != -1) {
            textButton.setTextColor(getResources().getColor(bacgroundColor));
        } else {
            // Color by hexadecimal
            String textColor = attrs.getAttributeValue(ANDROIDXML, "textColor");
            if(TextUtils.isEmpty(textColor))return;
            textButton.setTextColor(Color.parseColor(textColor));
        }
    }
//	/**
